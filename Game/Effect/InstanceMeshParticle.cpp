...
//	meshParticleBufferData = KazBufferHelper::SetOnlyReadStructuredBuffer(sizeof(InitOutputData) * PARTICLE_MAX_NUM);
//	meshParticleBufferData.rangeType = GRAPHICS_RANGE_TYPE_UAV_DESC;
//	meshParticleBufferData.rootParamType = GRAPHICS_PRAMTYPE_DATA;
//	meshParticleBufferData.bufferSize = sizeof(InitOutputData);
