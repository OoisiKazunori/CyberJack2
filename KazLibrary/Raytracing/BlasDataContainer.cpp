...
std::vector<std::shared_ptr<Raytracing::Blas>> Raytracing::BlasDataContainer::SetBlas(bool arg_isOpaque, int arg_vertexHandle, std::vector<std::vector<KazBufferHelper::BufferData>> arg_materialBuffer)
{
